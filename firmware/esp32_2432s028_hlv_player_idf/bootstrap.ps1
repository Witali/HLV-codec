...
# Filled with the SHA-256 values of the official release files.  Keeping these
# in source makes a repeated bootstrap deterministic and detects partial files.
