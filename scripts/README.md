...
| `transcode_mpeg4_simple.ps1` | `320x240` M4S2 AVI, MPEG-4 Simple Profile, GOP 30, I/P pictures only, full source FPS up to 30. Standard remains Q5; `-Preset Esp32Speed` is separately named, defaults to Q7, and produces a `_MPEG4SP_SPEED_q7` filename. |
