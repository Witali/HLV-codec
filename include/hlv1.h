 ...
 *
 * Width/height are visible dimensions.  Storage is padded to 16 luma pixels so
 * every 16x16 macroblock and its 8x8 chroma region can be accessed without a
 * partial-block branch.  Edge padding is generated by the Y4M reader.
 */
typedef struct HLV1Frame {
    ...
    int stride_u;
    int stride_v;
    uint8_t *storage;        /**< Single allocation backing all three planes. */
    uint8_t *y;
    uint8_t *u;
    uint8_t *v;
} HLV1Frame;
